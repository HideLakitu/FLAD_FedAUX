...
def process_pcap(pcap_file, dataset_type, in_labels, max_flow_len, labelled_flows, max_flows=0, traffic_type='all',
    ...
    if args.dataset_folder is not None and args.dataset_type is not None:
        ...
        for file in filelist:
            try:
                ...
                file, args.dataset_type[0], in_labels, max_flow_len, flows, args.max_flows, traffic_type, time_window))
